...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) == "edit") {
        ...
        $edit = mysqli_query($koneksi, "UPDATE tbarang SET
                                               nama = '$_POST[tnama]',
                                               nm_penerima = '$_POST[tnama_penerima]',
                                               asal = '$_POST[tasal]',
...
if (isset($_GET['hal'])) {
    ...
    if ($_GET['hal'] == "edit") {
        ...
        if ($data) {
            ...
            $vkode = $data['kode'];
            $vnama = $data['nama'];
            $vnama_penerima = $data['nm_penerima'];
            $vasal = $data['asal'];
            $vjumlah = $data['jumlah'];
            $vsatuan = $data['satuan'];
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tnama_penerima" value="<?= $vnm_penerima ?>" class="form-control"
